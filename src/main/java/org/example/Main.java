...
*/
    ...
    public void register(){
        ...
        driver.findElement(By.id("firstname")).sendKeys("eslam");
        driver.findElement(By.id("middlename")).sendKeys("mamdouh");
        driver.findElement(By.id("lastname")).sendKeys("mahmed");
        driver.findElement(By.id("email_address")).sendKeys("eslammadouh22@gmail.com");
        driver.findElement(By.id("password")).sendKeys("2278174Hd");
        driver.findElement(By.id("confirmation")).sendKeys("2278174Hd");
...
/*
    ...
    public void sharewishlist(){
        ...
        driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("eslammadouh22@gmail.com");
...
/*
    ...
    public void purschaseproductsandplaceorder() {
        ...
        driver.findElement(By.xpath("//*[@id=\"header\"]/div/div[2]/div/a/span[2]")).click();
        driver.findElement(By.xpath("//*[@id=\"header-account\"]/div/ul/li[6]/a")).click();
        driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("mahmedmadouh22@gmail.com");
        driver.findElement(By.id("pass")).sendKeys("2278174Hd");
        driver.findElement(By.xpath("//*[@id=\"send2\"]")).click();
        driver.findElement(By.xpath("//*[@id=\"nav\"]/ol/li[2]/a")).click();
